...
public class TileEntityDreadSingleUseSpawnerFinalBallista extends TileEntity implements ITickable {
    ...
    public void update() {
        if (isActivated()) {
            EntityFinalBallista mob = new EntityFinalBallista(world);
