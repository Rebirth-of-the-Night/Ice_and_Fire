...
public class LightningChargeExplosion extends Explosion {
    ...
    public LightningChargeExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean smoking) {
