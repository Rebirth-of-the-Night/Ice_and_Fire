...
public class EntityDreadKnightRoyal extends EntityDreadKnight {
    private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(EntityDreadKnightRoyal.class, DataSerializers.VARINT);
    public static Animation ANIMATION_SPAWN = Animation.create(40);
    private int animationTick;
    private Animation currentAnimation;
    public static final ItemStack SHIELD = generateShield();

    public EntityDreadKnightRoyal(World worldIn) {
        super(worldIn);
    ...
    private static ItemStack generateShield() {
        ...
        currentPattern.setInteger("Color", EnumDyeColor.BLACK.getDyeDamage());
        patterns.appendTag(currentPattern);
        ItemStack banner = ItemBanner.makeBanner(EnumDyeColor.SILVER, patterns);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(IceAndFire.CONFIG.dreadKnightRoyalMaxHealth);
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.25D);
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((float) IceAndFire.CONFIG.dreadKnightRoyalAttackStrength);
        this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(Math.min(2048, IceAndFire.CONFIG.dreadKnightRoyalTargetSearchLength));
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(IceAndFire.CONFIG.dreadKnightRoyalArmor);
