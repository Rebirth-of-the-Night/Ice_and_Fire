...
public class CyclopsAITargetSheepPlayers<T extends EntityPlayer> extends EntityAITarget {
    ...
    public boolean shouldExecute() {
        if (this.targetChance > 0 && this.taskOwner.getRNG().nextInt(this.targetChance) != 0) {
            ...
            this.targetEntity = (T) this.taskOwner.world.getNearestAttackablePlayer(this.taskOwner.posX,
                    this.taskOwner.posY + (double) this.taskOwner.getEyeHeight(), this.taskOwner.posZ,
                    this.getTargetDistance(), this.getTargetDistance(), new Function<EntityPlayer, Double>() {
                        ...
                        public Double apply(@Nullable EntityPlayer player) {
                            ...
                            double subHelm = helmet != null && helmet.getItem() != null
                                    && helmet.getItem() == IafItemRegistry.sheep_helmet ? 0.2D : 0;
                            double subChest = chestplate != null && chestplate.getItem() != null
                                    && chestplate.getItem() == IafItemRegistry.sheep_chestplate ? 0.2D : 0;
                            double subLegs = leggings != null && leggings.getItem() != null
                                    && leggings.getItem() == IafItemRegistry.sheep_leggings ? 0.2D : 0;
                            double subBoots = boots != null && boots.getItem() != null
                                    && boots.getItem() == IafItemRegistry.sheep_boots ? 0.2D : 0;
