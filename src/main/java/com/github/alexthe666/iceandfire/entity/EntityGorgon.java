...
public class EntityGorgon extends EntityMob implements IAnimatedEntity, IVillagerFear, IAnimalFear, IHumanoid {
    ...
    public static boolean isBlindfolded(EntityLivingBase attackTarget) {
        return attackTarget != null
                && (attackTarget.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() == IafItemRegistry.blindfold
                || attackTarget.isPotionActive(MobEffects.BLINDNESS)
                || BaublesCompatBridge.isWearSpecificBauble(attackTarget, IafItemRegistry.blindfold));
    }
