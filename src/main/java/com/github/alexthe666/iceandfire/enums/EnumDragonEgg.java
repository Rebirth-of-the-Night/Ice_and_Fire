...
public enum EnumDragonEgg {
    ...
    ELECTRIC(8, TextFormatting.DARK_BLUE, DragonType.LIGHTNING), AMYTHEST(5, TextFormatting.LIGHT_PURPLE, DragonType.LIGHTNING), COPPER(6, TextFormatting.GOLD, DragonType.LIGHTNING), BLACK(7, TextFormatting.DARK_GRAY, DragonType.LIGHTNING);
