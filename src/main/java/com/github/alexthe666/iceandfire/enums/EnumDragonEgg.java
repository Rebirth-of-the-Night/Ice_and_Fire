...
public enum EnumDragonEgg {
    ...
    ELECTRIC(8, TextFormatting.DARK_BLUE, DragonType.LIGHTNING), AMETHYST(9, TextFormatting.LIGHT_PURPLE, DragonType.LIGHTNING), COPPER(10, TextFormatting.GOLD, DragonType.LIGHTNING), BLACK(11, TextFormatting.DARK_GRAY, DragonType.LIGHTNING);
