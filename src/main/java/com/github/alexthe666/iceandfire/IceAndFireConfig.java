...
public class IceAndFireConfig {
    ...
    public int generateDragonSkeletonChance = 700;
    public int worldGenDistance = 500;
    public boolean generateDragonDens = true;
    public int generateDragonDenChance = 375;
    ...
    public float dragonAttackDamageSmokeDecrease = 2F;
    ...
    public boolean fireDragonUseSmokeAttack = true;
    ...
    public void init(Configuration config) {
        ...
        this.worldGenDistance = config.getInt("World Gen Distance", "all", 500, 0, Integer.MAX_VALUE, "How far apart dragon dens, cyclops caves, gorgon temples etc should spawn apart from eachother (this is kept seperate for each type: a dragon roost can still spawn next to a myrmex hive)");
        ...
        this.generateDragonSkeletonChance = config.getInt("Generate Dragon Skeleton Chance", "all", 700, 1, 10000, "1 out of this number chance per chunk for generation");
        this.generateDragonDens = config.getBoolean("Generate Dragon Caves", "all", true, "Whether to generate dragon caves or not");
        this.generateDragonDenChance = config.getInt("Generate Dragon Cave Chance", "all", 375, 1, 10000, "1 out of this number chance per chunk for generation");
        this.generateDragonRoosts = config.getBoolean("Generate Dragon Roosts", "all", true, "Whether to generate dragon roosts or not");
        this.generateDragonRoostChance = config.getInt("Generate Dragon Roost Chance", "all", 400, 1, 10000, "1 out of this number chance per chunk for generation");
        ...
        this.fireDragonUseSmokeAttack = config.getBoolean("Fire Dragon Ash Attack", "all", true, "Should Fire Dragon use Smoke attack when target immune fire.");
        this.dragonAttackDamageSmokeDecrease = config.getFloat("Dragon Attack Damage(Smoke breath)", "all", 2.0F, 1, 10000, "Damage decrease percentage when fire dragon use smoke attack.");
