...
public class RenderTideTrident extends Render<EntityTideTrident> {
    ...
    protected void render(EntityTideTrident p_203085_1_, double p_203085_2_, double p_203085_4_, double p_203085_6_, float p_203085_8_, float p_203085_9_) {
        ...
        double d3 = MathHelper.clampedLerp((double)p_203085_9_, entity.prevPosX, entity.posX);
        double d4 = MathHelper.clampedLerp((double)p_203085_9_, entity.prevPosY + (double)entity.getEyeHeight() * 0.8D, entity.posY + (double)entity.getEyeHeight() * 0.8D);
        double d5 = MathHelper.clampedLerp((double)p_203085_9_, entity.prevPosZ, entity.posZ);
        double d6 = d1 - d2;
        double d7 = d2 + d1;
        double d8 = MathHelper.clampedLerp((double)p_203085_9_, p_203085_1_.prevPosX, p_203085_1_.posX);
        double d9 = MathHelper.clampedLerp((double)p_203085_9_, p_203085_1_.prevPosY, p_203085_1_.posY);
        double d10 = MathHelper.clampedLerp((double)p_203085_9_, p_203085_1_.prevPosZ, p_203085_1_.posZ);
