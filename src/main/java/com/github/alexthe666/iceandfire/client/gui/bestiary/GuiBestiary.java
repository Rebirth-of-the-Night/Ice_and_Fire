...
/*
* Author : Kotlin_Programmer & Carver
* Tweaked by keletu
* */
...
public class GuiBestiary extends GuiScreen {
    ...
    public GuiBestiary(ItemStack book) {
        font = getFont();
        this.book = book;
        if (!book.isEmpty() && book.getItem() == IafItemRegistry.bestiary) {
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.previousPage = new ChangePageButton(0, centerX + 15, centerY + 215, false, 0));
        this.buttonList.add(this.nextPage = new ChangePageButton(1, centerX + 357, centerY + 215, true, 0));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!index) {
            ...
            font.drawString(String.valueOf(pageLeft), X / 4, Y - (int) (Y * 0.13), 0X303030, false);
    ...
    public void drawPerPage(int bookPages) {
        switch (this.pageType) {
            case INTRODUCTION:
                if (bookPages == 0) {
                    drawItemStack(new ItemStack(IafItemRegistry.manuscript), 30, 14, 2.5F);
                    drawItemStack(new ItemStack(IafBlockRegistry.silverOre), 110, 15, 2.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silverIngot), 140, 48, 2F);
                    int i = 133;
                    drawItemStack(new ItemStack(IafItemRegistry.silver_shovel), i += 16, 85, 1.51F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_pickaxe), i += 16, 85, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_axe), i += 16, 85, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_sword), i += 16, 85, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_hoe), i += 16, 85, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silverNugget), i += 16, 85, 1.5F);
                    int j = 148;
                    drawItemStack(new ItemStack(IafItemRegistry.silver_helmet), j += 16, 100, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_chestplate), j += 16, 100, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_leggings), j += 16, 100, 1.5F);
                    drawItemStack(new ItemStack(IafItemRegistry.silver_boots), j += 16, 100, 1.5F);
                }
                if (bookPages == 1) {
            ...
            case ALCHEMY:
                ...
                if (bookPages == 0) {
                    GL11.glPushMatrix();
                    GL11.glScalef(1.5F, 1.5F, 1F);
                    drawItemStack(new ItemStack(IafItemRegistry.fire_dragon_blood), 10, 24, 2.25F);
                    drawItemStack(new ItemStack(IafItemRegistry.ice_dragon_blood), 20, 24, 2.25F);
                    drawItemStack(new ItemStack(IafItemRegistry.lightning_dragon_blood), 30, 24, 2.25F);
                    GL11.glPopMatrix();
                    boolean drawFire = Minecraft.getMinecraft().player.ticksExisted % 60 < 20;
                    boolean drawIce = Minecraft.getMinecraft().player.ticksExisted % 60 > 41;
                    drawItemStack(new ItemStack(IafItemRegistry.dragonbone_sword), 161, 17, 1.5F);
                    drawItemStack(new ItemStack(drawFire ? IafItemRegistry.fire_dragon_blood : drawIce ? IafItemRegistry.ice_dragon_blood : IafItemRegistry.lightning_dragon_blood), 161, 32, 1.5F);
                    drawItemStack(new ItemStack(drawFire ? IafItemRegistry.dragonbone_sword_fire : drawIce ? IafItemRegistry.dragonbone_sword_ice : IafItemRegistry.dragonbone_sword_lightning), 151, 10, 2F);
                    GL11.glPushMatrix();
                    GL11.glScalef(1.5F, 1.5F, 1F);
                    drawImage(DRAWINGS_0, 144, 0, 389, 1, 50, 50);
                    GL11.glPopMatrix();
            ...
            case HIPPOGRYPH:
                if (bookPages == 0) {
                    ...
                    drawImage(DRAWINGS_0, 29, 190, 303, 187, 61, 36);
            ...
            case SEASERPENT:
                if(bookPages == 0) {
                    ...
                    drawImage(DRAWINGS_1, 380, 70, 422, 192, 90, 64);
    ...
    public void drawImage(ResourceLocation texture, int x, int y, int u, int v, int width, int height) {
        this.mc.renderEngine.bindTexture(texture);
        drawModalRectWithCustomSizedTexture(x, y, u, v, width, height, 512F, 512F);
    }
