...
public class ModelBloodedFireDragonArmor extends ModelFireDragonArmor {
    ...
    private static final ResourceLocation BLOOD_FRAME_1 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor1.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_1 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs1.png");
    private static final ResourceLocation BLOOD_FRAME_2 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor2.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_2 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs2.png");
    private static final ResourceLocation BLOOD_FRAME_3 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor3.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_3 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs3.png");
    private static final ResourceLocation BLOOD_FRAME_4 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor4.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_4 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs4.png");
    private static final ResourceLocation BLOOD_FRAME_5 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor5.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_5 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs5.png");
    private static final ResourceLocation BLOOD_FRAME_6 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor6.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_6 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs6.png");
    private static final ResourceLocation BLOOD_FRAME_7 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor7.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_7 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs7.png");
    private static final ResourceLocation BLOOD_FRAME_8 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor8.png");
    private static final ResourceLocation BLOOD_FRAME_LEGS_8 = new ResourceLocation("iceandfire:textures/models/armor/" + "flamed" + "_armor_legs8.png");
