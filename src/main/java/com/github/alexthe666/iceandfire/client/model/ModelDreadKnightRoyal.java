...
public class ModelDreadKnightRoyal extends ModelDragonBase {
    ...
    public ModelDreadKnightRoyal(float modelSize, boolean armorArms) {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        EntityDreadKnightRoyal thrall = (EntityDreadKnightRoyal) entityIn;
        ...
        if (thrall.getAnimation() == EntityDreadKnightRoyal.ANIMATION_SPAWN) {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        animator.setAnimation(EntityDreadKnightRoyal.ANIMATION_SPAWN);
