...
public class ModelLightningDragonArmor extends ModelBiped {
    ...
    public ModelLightningDragonArmor(float modelSize, boolean legs) {
        ...
        this.HornR3 = new ModelRenderer(this, 47, 37);
        this.HornR3.mirror = true;
        this.HornR3.setRotationPoint(-4.0F, -3.0F, 0.7F);
        ...
        this.HornR4.setRotationPoint(-4.0F, -5.1F, 0.1F);
        ...
        this.Teeth4 = new ModelRenderer(this, 6, 34);
        this.Teeth4.mirror = true;
        this.Teeth4.setRotationPoint(0.0F, 3.0F, 1.4F);
        ...
        this.HornL3 = new ModelRenderer(this, 47, 37);
        this.HornL3.mirror = true;
        this.HornL3.setRotationPoint(4.0F, -3.0F, 0.7F);
        ...
        this.HornL.setRotationPoint(3.6F, -8.0F, 0.0F);
        ...
        this.HornR.setRotationPoint(-3.6F, -8.0F, 0.0F);
        ...
        this.Teeth3 = new ModelRenderer(this, 6, 34);
        this.Teeth3.setRotationPoint(0.0F, 3.0F, 1.4F);
        ...
        this.HornL4.setRotationPoint(4.0F, -5.1F, -0.1F);
        ...
        if(legs){
            ...
            this.bipedHead.addChild(this.Teeth1);
