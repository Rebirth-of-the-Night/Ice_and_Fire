 ...
 *
 * */
public class ItemBloodedArmor extends ItemArmor implements IProtectAgainstDragonItem, IElementalThornArmor {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced) {
        tooltip.add(eggType.color + net.minecraft.client.resources.I18n.format("dragon." + eggType.toString().toLowerCase()));
