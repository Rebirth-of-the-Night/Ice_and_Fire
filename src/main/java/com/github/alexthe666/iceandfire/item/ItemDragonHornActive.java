...
public class ItemDragonHornActive extends Item {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		if (stack.getTagCompound() != null) {
			...
			String name = stack.getTagCompound().getString("CustomName").isEmpty() ? I18n.translateToLocal("dragon.unnamed") : I18n.translateToLocal("dragon.name") + stack.getTagCompound().getString("CustomName");
			tooltip.add(name);
			String gender = I18n.translateToLocal("dragon.gender") + I18n.translateToLocal((stack.getTagCompound().getBoolean("Gender") ? "dragon.gender.male" : "dragon.gender.female"));
			tooltip.add(gender);
			...
			String stage = I18n.translateToLocal("dragon.stage") + stage1 + " " + I18n.translateToLocal("dragon.days.front") + stagenumber + " " + I18n.translateToLocal("dragon.days.back");
			tooltip.add(stage);
		}
	}
